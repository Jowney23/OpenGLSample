...
//                "    gl_FragColor = vec4(tc.r,tc.g,tc.b,1.0);\n" +
    ...
    public CameraGLRender(CameraGLSurfaceView cameraGLSurfaceView) {
        this.cameraGLSurfaceView = cameraGLSurfaceView;
        //初始化摄像头

        mSurfaceTexture = new SurfaceTexture(createOESTextureObject());
        CameraManerge.openCamera(mSurfaceTexture);
...
//            int fragmentShader = loadShader(GLES20.GL_FRAGMENT_SHADER, fragmentSource);
    ...
    private void activeProgram() {
        ...
        mSurfaceTexture.setOnFrameAvailableListener(cameraGLSurfaceView);
        // 获取顶点着色器的位置的句柄
