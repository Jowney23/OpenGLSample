...
public class MyGLSurfaceView06 extends GLSurfaceView {

    private final MyGLRenderer06 mRenderer;

    public MyGLSurfaceView06(Context context) {
        super(context);
